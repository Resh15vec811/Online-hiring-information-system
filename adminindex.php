...
header("location: profilecand.php");
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <img style="float:left;" src="sng.jpg" class="img-rounded"  height="55" width="55" alt="Cinque Terre">
      <p class="navbar-brand">  Light the light in you</p>
    </div>
