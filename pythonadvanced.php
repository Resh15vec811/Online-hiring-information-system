    ...
    if(isset($_POST['submit']))
{
   ...
   $correct_choice=$_POST['correct_choice'];
    ...
    $query="INSERT INTO pythonadvancequestions(question_number,text) VALUES('$question_number','$question_text')";
...
$query="INSERT INTO pythonadvancechoices(question_number,is_correct,text)VALUES('$question_number','$is_correct','$value')";
