...
if(!isset($_SESSION['score'])){
	...
	$sql = "SELECT count(question_number) FROM javaadvancequestions";
...
$query="SELECT * FROM javaadvancechoices
           WHERE question_number=$random";
...
function countDown(secs,elem){
  ...
  if(secs < 1){
       clearTimeout(timer);
         window.location="javaadvancefinal.php";
...
<script type="text/javascript">countDown(10,"status");</script>
	...
	<?php echo $question['text']; ?>
		...
		<form method="post" action="javaadvanceprocess.php">
		<ul class="choices">
