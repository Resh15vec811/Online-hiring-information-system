    ...
    if(isset($_POST['submit']))
{
   ...
   $correct_choice=$_POST['correct_choice'];
    ...
    $query="INSERT INTO phpinterquestions(question_number,text) VALUES('$question_number','$question_text')";
...
$query="INSERT INTO phpinterchoices(question_number,is_correct,text)VALUES('$question_number','$is_correct','$value')";
