...
{
     $query="SELECT * FROM phpadvancequestions";
   ...
   $correct_choice=$_POST['correct_choice'];
    ...
    $query="INSERT INTO phpadvancequestions(question_number,text) VALUES('$question_number','$question_text')";
...
$query="INSERT INTO phpadvancechoices(question_number,is_correct,text)VALUES('$question_number','$is_correct','$value')";
