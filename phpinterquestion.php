...
<?php
 if(!isset($_SESSION['score'])){
	...
	$sql = "SELECT count(question_number) FROM phpinterquestions";
...
$query="SELECT * FROM phpinterchoices 
           WHERE question_number=$random";
...
function countDown(secs,elem){
  ...
  if(secs < 1){
       clearTimeout(timer);
         window.location="phpinterfinal.php";
...
<script type="text/javascript">countDown(10,"status");</script>
	...
	<?php echo $question['text']; ?>
		...
		<form method="post" action="phpinterprocess.php">
		<ul class="choices">
