...
{
     $query="SELECT * FROM javainterquestions";
   ...
   $correct_choice=$_POST['correct_choice'];
    ...
    $query="INSERT INTO javainterquestions(question_number,text) VALUES('$question_number','$question_text')";
...
$query="INSERT INTO javainterchoices(question_number,is_correct,text)VALUES('$question_number','$is_correct','$value')";
