...
<center>
  <header>
   <div class="container-fluid">
    ...
    <center><h2>JAVA INTERMEDIATE QUIZ</h2></center>
    </div>
   </header>
<main>
   <div class="container">
   <h2>Test your skills</h2>
<p><b>THis is a multiple choice quiz.</b></p>
<ul>
<li> <strong>Number of questions:</strong><?php echo $total; ?></li>
<li> <strong>Duration:</strong>50 secs</li>
</ul>
<a href="javainterquestion.php?n=1" class="start">Start Quiz</a>
   </div>
</div>
</main>
