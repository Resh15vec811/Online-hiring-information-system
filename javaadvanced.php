...
{
     $query="SELECT * FROM javaadvancequestions";
   ...
   $correct_choice=$_POST['correct_choice'];
    ...
    $query="INSERT INTO javaadvancequestions(question_number,text) VALUES('$question_number','$question_text')";
...
$query="INSERT INTO javaadvancechoices(question_number,is_correct,text)VALUES('$question_number','$is_correct','$value')";
...
<div class="jumbotrontext-justify">
<h2>JAVA ADVANCE</h2><br>
   ...
   ?>
        <script>
          ...
          window.location.href='add2.php?success';
        </script>
