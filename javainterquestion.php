...
<?php
 if(!isset($_SESSION['score'])){
	...
	$sql = "SELECT count(question_number) FROM javainterquestions";
...
$query="SELECT * FROM javainterchoices 
           WHERE question_number=$random";
...
function countDown(secs,elem){
  ...
  if(secs < 1){
       clearTimeout(timer);
         window.location="javainterfinal.php";
...
<script type="text/javascript">countDown(10,"status");</script>
	...
	<?php echo $question['text']; ?>
		...
		<form method="post" action="javainterprocess.php">
		<ul class="choices">
