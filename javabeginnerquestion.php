...
<?php
	...
	$sql = "SELECT count(question_number) FROM javabeginnerquestions";
...
$query="SELECT * FROM javabeginnerchoices 
           WHERE question_number=$random";
...
function countDown(secs,elem){
  ...
  if(secs < 1){
       clearTimeout(timer);
         window.location="javabeginnerfinal.php";
        }
...
<script type="text/javascript">countDown(10,"status");</script>
	...
	<?php echo $question['text']; ?>
		...
		<form method="post" action="javabeginnerprocess.php">
		<ul class="choices">
