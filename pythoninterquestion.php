...
<?php
 if(!isset($_SESSION['score'])){
	...
	$sql = "SELECT count(question_number) FROM pythoninterquestions";
...
$query="SELECT * FROM pythoninterchoices 
           WHERE question_number=$random";
...
function countDown(secs,elem){
  ...
  if(secs < 1){
       clearTimeout(timer);
         window.location="pythoninterfinal.php";
...
<script type="text/javascript">countDown(10,"status");</script>
	...
	<header>
	<div class="container">
	<h1>PYTHON IMTERMEDIATE QUIZ</h1>
	</div>
	</header>
	<main>
	<div class="container">
	...
	<?php echo $question['text']; ?>
		...
		<form method="post" action="pythoninterprocess.php">
		<ul class="choices">
