...
<?php
	...
	$sql = "SELECT count(question_number) FROM phpbeginnerquestions";
...
$query="SELECT * FROM phpbeginnerchoices 
           WHERE question_number=$random";
...
function countDown(secs,elem){
  ...
  if(secs < 1){
       clearTimeout(timer);
         window.location="phpbeginnerfinal.php";
        }
...
<script type="text/javascript">countDown(10,"status");</script>
	...
	<?php echo $question['text']; ?>
		...
		<form method="post" action="phpbeginnerprocess.php">
		<ul class="choices">
