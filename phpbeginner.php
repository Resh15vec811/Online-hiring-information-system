...
{
     $query="SELECT * FROM phpbeginnerquestions";
   ...
   $correct_choice=$_POST['correct_choice'];
    ...
    $query="INSERT INTO phpbeginnerquestions(question_number,text) VALUES('$question_number','$question_text')";
...
$query="INSERT INTO phpbeginnerchoices(question_number,is_correct,text)VALUES('$question_number','$is_correct','$value')";
