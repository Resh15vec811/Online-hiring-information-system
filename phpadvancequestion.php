...
<?php
 if(!isset($_SESSION['score'])){
	...
	$sql = "SELECT count(question_number) FROM phpadvancequestions";
...
$query="SELECT * FROM phpadvancechoices
           WHERE question_number=$random";
...
function countDown(secs,elem){
  ...
  if(secs < 1){
       clearTimeout(timer);
         window.location="phpadvancefinal.php";
...
<body>
	...
	<center><h2>PHP ADVANCE QUIZ</h2></center>
	</div>
	</header>
	<main>
	<div class="container-fluid">
	...
	<?php echo $question['text']; ?>
		...
		<form method="post" action="phpadvanceprocess.php">
		<ul class="choices">
