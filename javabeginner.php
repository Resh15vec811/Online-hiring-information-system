...
{
     $query="SELECT * FROM javabeginnerquestions";
   ...
   $correct_choice=$_POST['correct_choice'];
    ...
    $query="INSERT INTO javabeginnerquestions(question_number,text) VALUES('$question_number','$question_text')";
...
$query="INSERT INTO javabeginnerchoices(question_number,is_correct,text)VALUES('$question_number','$is_correct','$value')";
