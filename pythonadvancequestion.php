...
<?php
 if(!isset($_SESSION['score'])){
	...
	$sql = "SELECT count(question_number) FROM pythonadvancequestions";
...
$query="SELECT * FROM pythonadvancechoices
           WHERE question_number=$random";
...
function countDown(secs,elem){
  ...
  if(secs < 1){
       clearTimeout(timer);
         window.location="pythonadvancefinal.php";
...
<script type="text/javascript">countDown(10,"status");</script>
	...
	<?php echo $question['text']; ?>
		...
		<form method="post" action="pythonadvanceprocess.php">
		<ul class="choices">
